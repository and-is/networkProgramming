/*
 * WARNING
 * SCP is deprecated and may show warnings upon compilation.
 * Use gcc ssh_download.c -o ssh_download -lssh -Wno-deprecated-declarations
 * to suppress the warnings.
 * Use SFTP in the future usage
 */
